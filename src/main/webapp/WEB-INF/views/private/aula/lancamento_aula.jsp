		...
		<div class="col-sm-12">
			<div class="add-comment add-comment-velvet styled" id="addcomments">
				...
				<div class="comment-form">
					<form:form action="#" method="post" id="commentForm" class="ajax_form">
						<div class="form-inner">
							<div class="row">
								<div class="col-md-4">
									<div class="field_text">
							           	<label for="dataHoraCadastro" class="label_title">Data Aula:</label>
							            <input type="text" name="dataAula" id="dataAula" value='<fmt:formatDate pattern="dd/MM/yyyy"  value="${data_atual}"/>' class="inputtext input_middle required" readOnly="readonly" />
							        </div>
	                           	</div>
	                           	<div class="col-md-5">
									<div class="field_text">
