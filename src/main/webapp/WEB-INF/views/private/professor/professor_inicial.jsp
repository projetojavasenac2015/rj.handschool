            ...
            <div class="tabs_framed styled">
                <div class="inner">
                    <ul class="tabs clearfix active_bookmark1">
                        ...
                        <li>
                            <a href="#reminders" data-toggle="tab">Turmas</a>
                        </li>
                        <li><a href="#starred" data-toggle="tab">Quadro de Avaliacoes</a></li>
                        <li><a href="#archive" data-toggle="tab"></a></li>
                    </ul>
                                            ...
                                            <div id="myCarousel" class="carousel slide" data-interval="20000">
                                                <div class="carousel-inner">
                                                    <div class="active item">
                                                        <div class="widget-container widget_profile col-10" >
                                                            <div class="inner">
                                                                <div class="widget_profile_top clearfix" style="margin-bottom:50px">
                                                                    <div class="avatar"><img src="images/temp/avatar.png" alt="" /></div>
                                                                    <h5>Fulano</h5>
                                                                    <span class="subtitle">PROFISSAO</span>
                                                                    <div class="follow">
